...
public struct BottleHealthAuditService {
    ...
    private static func requiredCompatibilityEnvironmentKeys(for profile: ApplicationCompatibilityProfile) -> Set<String> {
        ...
        case .dbeaverSWT:
            keys.formUnion(["MACWIN_APP_MODE_INPUT_REPAIR", "MACWIN_DBEAVER_SWT_REPAIR", "MACWIN_FONT_FALLBACK_REPAIR", "MACWIN_FORCE_MOUSE_FOCUS", "MACWIN_LAUNCH_CWD", "ROSETTA_X87_PATH", "WINE_D3D_CONFIG", "WINEDLLOVERRIDES"])
        case .kritaOpenGL:
