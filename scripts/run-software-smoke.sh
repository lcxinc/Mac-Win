...
run_chromium_browser_workload() {
  ...
  local common_args=(
    ...
    --disable-features=RendererCodeIntegrity,CalculateNativeWinOcclusion,VizDisplayCompositor,Vulkan,WebGPU,DirectCompositionUseDCompVisualTree,UseDCompVisualTree,CanvasOopRasterization,DawnGraphite,SkiaGraphite,RawDraw,DrDc
  )
